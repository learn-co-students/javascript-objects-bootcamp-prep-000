...
1. Open `objects.js`
2. Assign an object to the variable `playlist` — the keys will be artist names and the values will be song titles. Add a key-value pair to `playlist`. (What limitation does this impose on our `playlist`?)
